...
class ModelTraining:
    def __init__(self, data_path):
        ...
        self.experiment = comet_ml.Experiment(
            api_key = 'cTkEK0zWKzvEiL01cqHMtOYWG',
            project_name = 'mlops-project-2',
            workspace = 'rohitdusane'
        )

        logging.info('Model Training and Experimentation Initailized...')
    ...
    def load_data(self):
        try:
            ...
            logging.info('Data loaded for Modle Training')
    ...
    def train_model(self):
        try:
            ...
            os.makedirs(WEIGHTS_DIR.parent, exist_ok=True)
    ...
    def save_model_weights(self,model):
        try:
            ...
            raise CustomException("Failed to save model and weights Process",sys)
